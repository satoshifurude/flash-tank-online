package 
{
    ...
    public class RoomScene extends Sprite
    {
        ...
        {	
			...
			mBtnChangeSide= new Button(ResourceManager.getInstance().getTexture(ResourceDefine.TEX_BTN_START_1), "", ResourceManager.getInstance().getTexture(ResourceDefine.TEX_BTN_START_1));
